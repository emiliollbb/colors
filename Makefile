...
SDL_WIN= /opt/sdlwin/SDL2-2.0.18/x86_64-w64-mingw32
SDL_WIN_IMAGE= /opt/sdlwin/SDL2_image-2.0.5/x86_64-w64-mingw32
SDL_WIN_TTF= /opt/sdlwin/SDL2_ttf-2.0.15/x86_64-w64-mingw32
SDL_WIN_MIXER= /opt/sdlwin/SDL2_mixer-2.0.4/x86_64-w64-mingw32
...
colors.exe: main.win.o jengine.win.o game.win.o microtar.win.o
	x86_64-w64-mingw32-g++ $(LIB_WIN) -static main.win.o jengine.win.o microtar.win.o game.win.o `$(SDL_WIN)/bin/sdl2-config --static-libs` -lSDL2_image -lSDL2_ttf.dll -lSDL2_ttf -lSDL2_mixer.dll -lSDL2_mixer -o colors.exe

colors.dat: background.png sprites.png
	tar cvf colors.dat background.png sprites.png

colors.zip: colors.exe colors.dat
	zip -j colors.zip colors.exe colors.dat $(SDL_WIN)/bin/SDL2.dll $(SDL_WIN_IMAGE)/bin/libpng16-16.dll $(SDL_WIN_IMAGE)/bin/zlib1.dll $(SDL_WIN_TTF)/bin/SDL2_ttf.dll $(SDL_WIN_TTF)/bin/libfreetype-6.dll $(SDL_WIN_MIXER)/bin/SDL2_mixer.dll background.png
